...
public class Animation {
    ...
    public static final float ANIM_SCALE_FACTOR_MIN = 0.5f;
    public static final float ANIM_SCALE_FACTOR_ORIGINAL = 1.0f;
    public static final float ANIM_SCALE_FACTOR_MAX = 1.25f;

    public static final float ANIM_ALPHA_MIN = 0f;
    public static final float ANIM_ALPHA_MAX = 1.0f;
     ...
     * @param <V>
     */
    public static <V extends View> void itemAnimFromXDesc(V view, float xInit, float xFinal, float factor, int duration) {
     ...
     * @param <V>
     */
    public static <V extends View> void itemAnimFromXAsc(V view, float xInit, float xFinal, float factor, int duration) {
        view.setTranslationX(xInit);
        view.animate()
                .translationX(xFinal)
     ...
     * @param <V>
     */
    public static <V extends View> void itemAnimFromYDesc(V view, float yInit, float yFinal, float factor, int duration) {
     ...
     * @param <V>
     */
    public static <V extends View> void itemAnimFromYAsc(V view, float yInit, float yFinal, float factor, int duration) {
        view.setTranslationY(yInit);
        view.animate()
                .translationY(yFinal)
                .setInterpolator(new AccelerateInterpolator(factor))
     ...
     * @param <V>
     */
    public static <V extends View> void itemAnimScaleDesc(V view, float scaleInitial, float scaleFinal, float factor, int duration) {
     ...
     * @param <V>
     */
    public static <V extends View> void itemAnimScaleAsc(V view, float scaleInitial, float scaleFinal, float factor, int duration) {
        view.setScaleX(scaleInitial);
        view.setScaleY(scaleInitial);
        view.animate()
                .scaleX(scaleFinal)
     ...
     * @param <V>
     */
    public static <V extends View> void itemAnimFadeDesc(V view, float alphaInitial, float alphaFinal, float factor, int duration) {
     ...
     * @param <V>
     */
    public static <V extends View> void itemAnimFadeAsc(V view, float alphaInitial, float alphaFinal, float factor, int duration) {
        view.setAlpha(alphaInitial);
        view.animate()
                .alpha(alphaFinal)
                .setInterpolator(new AccelerateInterpolator(factor))

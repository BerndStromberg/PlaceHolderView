package com.mindorks.swipeplaceholderview;
...
import com.mindorks.swipeplaceholderview.swipe.SwipeView;
...
//    TODO: Make mHasInterceptedEvent a AtomicBoolean, to make it thread safe.
     ...
     * @param callback
     */
    public void bindView(V promptsView, int position, int swipeType, SwipeDecor decor,
     ...
     */
    public void setSwipeInMsgView(View swipeInMsgView) {
     ...
     */
    public void setSwipeOutMsgView(View swipeOutMsgView) {
     ...
     * @param <T>
     */
    public interface SwipeCallback<T extends SwipeViewBinder<?, ? extends FrameLayout>> {
